...
class Spotify:
    ...
    def current_user_playlist_create(self, name, public=..., collaborative=..., description=...) -> Any | None:
    ...
    def current_user_saved_items(self, uris) -> Any | None:
        """
    ...
    def current_user_playing_track(self, market=..., additional_types=...) -> Any | None:
